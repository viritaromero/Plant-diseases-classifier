...
# Developing an AI application: Plant diseased classifier
...
Computer Vision is my favorite fields of Deep Learning. There are many areas Computer Vision can help to. In this notebook I will implement a deep learning model that can identify plant diseases, using Pytorch framework,  a Convolutional Neural Network (CNN) architecture and the Plant Village dataset.
...
The Plant Village dataset contains 38 different plan disease classes and 1 background class from Stanford's open dataset of background images
The classes are:
